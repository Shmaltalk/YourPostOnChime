...
def emoji_result():
  ...
  if (emoji_string):
    ...
    return render_template('EmojiOutput.html', tweet_link=tweet_link, tweet_text=tweet_text, media_descrip=media_descrip, emoji_string=emoji_string, tweet_embed=tweet_embed)
